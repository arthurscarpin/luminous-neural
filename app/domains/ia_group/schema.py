...
class IAGroupCreateSchema(BaseModel):
    ...
    description: Annotated[str, Field(min_length=10, max_length=255, description='Description of the ia_group')]
...
class IAGroupUpdateSchema(BaseModel):
    """Schema for updating an IA Group. All fields optional."""
