...
class EnterpriseCreateSchema(BaseModel):
    ...
    description: Annotated[str, Field(str, min_length=10, max_length=255, description='Description of the enterprise')]
    ia_model: Annotated[str, Field(str, min_length=3, max_length=50, description='AI model associated with the enterprise')]
