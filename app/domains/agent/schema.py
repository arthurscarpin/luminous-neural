...
class AgentCreateSchema(BaseModel):
    ...
    description: Annotated[str, Field(min_length=10, max_length=255, description='Description of the agent')]
    system_message: Annotated[str, Field(min_length=10, max_length=255, description='System Message of the agent')]
...
class AgentUpdateSchema(BaseModel):
    ...
    system_message: Optional[Annotated[str, Field(min_length=10, max_length=255, description='System Message of the agent')]] = None
