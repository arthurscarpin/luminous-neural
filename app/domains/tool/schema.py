...
class ToolCreateSchema(BaseModel):
    ...
    description: Annotated[str, Field(min_length=10, max_length=255, description='Description of the Tool')]
    path: Annotated[str, Field(min_length=10, max_length=255, description='Path of the Tool')]
...
class ToolUpdateSchema(BaseModel):
    ...
    path: Optional[Annotated[str, Field(min_length=10, max_length=255, description='Path of the Tool')]] = None
